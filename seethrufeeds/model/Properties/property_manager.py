import seethrufeeds.model.Properties.properties
from seethrufeeds.model.Properties.properties import PropertyBase
...
class PropertyManager:
    ...
    def initialise(self):
        ...
        if self.Properties is None or type(self.Properties) is not dict:
            ...
            for attr in self.__dir__():
                ...
                if isinstance(prop, seethrufeeds.Model.Properties.Properties.PropertyBase):
    ...
    def set_property(self, prop, value):
        ...
        self.initialise()
        # Data validation
        if not isinstance(prop, seethrufeeds.Model.Properties.Properties.PropertyBase) and type(prop) != str:
    ...
    def FillableProperties(self):
        ...
        fillable = [prop for prop in self.Properties.values() if isinstance(prop, seethrufeeds.Model.Properties.Properties.FillableProperty)]
        return fillable
    ...
    def ResultProperties(self):
        ...
        results = [prop for prop in self.Properties.values() if isinstance(prop, seethrufeeds.Model.Properties.Properties.ResultProperty)]
        return results
