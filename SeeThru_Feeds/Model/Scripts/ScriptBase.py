...
class ScriptBase(PropertyManager):
    ...
    def Script_Run(self):
        ...
        raise NotImplementedError(
            "There is no execution method defined, please define it with 'Script_Run'")
    ...
    def Script_Evaluate(self, result):
        ...
        """
        raise NotImplementedError(
            "There is not evaluation method defined, please define it with 'Script_Evaluate'")
    ...
    def ExportToOutput(self):
        ...
        Returns:
            ScriptBase -- The script
        """
        if self.ScriptOutputPath == None:
            raise Exception("There is no output path specificed")
        ...
        if filePath.parent.exists():
            ...
            raise Exception("Directory for output file '{}' does not exist".format(
                self.ScriptOutputPath))
        return self
    ...
    def LogOutput(self):
        ...
        Returns:
            ScriptBase -- The script
        """
        if (self.GetInternalAlias() != None):
            print("--{}".format(self.GetInternalAlias()))
        print("Status: {}\nMessage: {}".format(
            self.ScriptResult.status, self.ScriptResult.message))
        return self
    ...
    def GetResult(self):
        ...
        """
        if "ScriptResult" not in dir(self) or type(self.Properties) != ScriptResult:
            self.EvaluateScript()
    ...
    def GetTitle(cls):
        ...
        """
        if cls.Script_Title == None:
            raise NotImplementedError(
                "There is no title defined, please define it as 'Script_Title='")
    ...
    def GetDescription(cls):
        ...
        """
        if cls.Script_Description == None:
            raise NotImplementedError(
                "There is no description defined, please define it as 'Script_Description='")
    ...
    def GetAuthor(cls):
        ...
        """
        if cls.Script_Author == None:
            raise NotImplementedError(
                "There is no author defined, please define it as 'Script_Author='")
    ...
    def GetOwner(cls):
        ...
        """
        if cls.Script_Owner == None:
            raise NotImplementedError(
                "There is no owner defined, please define it as 'Script_Owner='")
    ...
    def GetSupportLink(cls):
        ...
        """
        if cls.Script_SupportLink == None:
            raise NotImplementedError(
                "There is no supportLink defined, please define it as 'Script_SupportLink='")
    ...
    def GetDocLink(cls):
        ...
        """
        if cls.Script_DocLink == None:
            raise NotImplementedError(
                "There is no DocLink defined, please define it as 'Script_DocLink='")
    ...
    def GetLicenseLink(cls):
        ...
        """
        if cls.Script_LicenseLink == None:
            raise NotImplementedError(
                "There is no LicenseLink defined, please define it as 'Script_LicenseLink='")
